...
submitBtn.addEventListener("click", () => {
    const allInput = form.querySelectorAll(".fields input, .fields select");
    ...
    //const adminInput = form.querySelector("#usertype");
    //const selectedType = adminInput.value;
    //const validTypes = ["Admin", "Staff", "Official"];
